...
- (void)reconnectConnectionId:(NSString *)connectionId completion:(void(^)(NSString *_Nullable, FlutterError *_Nullable))completion;
- (void)stopConnectionId:(NSString *)connectionId completion:(void(^)(FlutterError *_Nullable))completion;
- (void)isConnectedConnectionId:(NSString *)connectionId completion:(void(^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
- (void)invokeMethodMethodName:(NSString *)methodName connectionId:(NSString *)connectionId arguments:(NSArray<NSString *> *)arguments completion:(void(^)(NSString *_Nullable, FlutterError *_Nullable))completion;
@end
...
- (void)onNewMessageHubName:(NSString *)hubName message:(NSString *)message connectionId:(NSString *)connectionId completion:(void(^)(NSError *_Nullable))completion;
@end
