      ...
      } else 
{
  ...
  public interface SignalRHostApi {
    ...
    void invokeMethod(@NonNull String methodName, @NonNull String connectionId, @NonNull List<String> arguments, Result<String> result);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              String connectionIdArg = (String)args.get(1);
              if (connectionIdArg == null) {
                throw new NullPointerException("connectionIdArg unexpectedly null.");
              }
              List<String> argumentsArg = (List<String>)args.get(2);
              ...
              api.invokeMethod(methodNameArg, connectionIdArg, argumentsArg, resultCallback);
            }
            catch (Error | RuntimeException exception) {
              ArrayList<Object> wrappedError = wrapError(exception);
              reply.reply(wrappedError);
