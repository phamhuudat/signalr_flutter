...
class SignalRHostApi {
  ...
  Future<String> invokeMethod(String arg_methodName, String arg_connectionId, List<String?> arg_arguments) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.SignalRHostApi.invokeMethod', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_methodName, arg_connectionId, arg_arguments]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
